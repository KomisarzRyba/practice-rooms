...
export const StudioUpsertArgsSchema: z.ZodType<Prisma.StudioUpsertArgs> = z.object({
  select: StudioSelectSchema.optional(),
  include: StudioIncludeSchema.optional(),
  where: StudioWhereUniqueInputSchema,
  create: z.union([ StudioCreateInputSchema,StudioUncheckedCreateInputSchema ]),
  update: z.union([ StudioUpdateInputSchema,StudioUncheckedUpdateInputSchema ]),
}).strict()

export default StudioUpsertArgsSchema;
